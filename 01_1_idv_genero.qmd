---
title: "1.1 Intención de voto por género"
---
...
p_idv_gndr <- ggplot(df_idv_gndr, aes(
  ...
  tooltip = paste0("<b>", idv_group, "</b><br>",
                   format(mes, "%B %Y", locale = "es_ES.UTF-8"), ": ",
                   perc, "%")
)) +
  geom_line_interactive(linewidth = .8) +
  geom_point_interactive(
    data = ultimo_por_grupo(df_idv_gndr, idv_group, mes),
    size = 3
  ) +
  ...
  theme_minimal() +
  labs(
    subtitle = "Evolución de la intención de voto según <b>género</b> para
      <br><span style='color:#E3001B'><b>PSOE</b></span>, 
