...
resumen <- df_idv %>%
  ...
  mutate(
    ...
    texto = glue(
      ...
      "En {format(mes_fin, '%B de %Y', locale='es_ES.UTF-8')} un {perc_fin}% afirma que les votará. ",
      "En {format(mes_ini, '%B de %Y', locale='es_ES.UTF-8')} lo hacía un {perc_ini}%, una diferencia de {diff} puntos. ",
